            ...
            <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div class="space-y-5">
                    <a href="index.html" class="flex items-center gap-2.5 group">
                        <div class="w-10 h-10 bg-green-600 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg group-hover:scale-110 transition duration-300">
                    ...
                    <p class="text-sm text-gray-500 leading-relaxed">
                        Your #1 trusted source for safe, secure, and verified Android APK downloads.
                    </p>
                    <div class="flex gap-3 pt-2">
                        <a href="#" class="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-blue-600 hover:text-white transition"><i class="ph-fill ph-facebook-logo text-xl"></i></a>
                        <a href="#" class="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-black hover:text-white transition"><i class="ph-fill ph-x-logo text-xl"></i></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm font-medium text-gray-500">
                        <li><a href="index.html" class="hover:text-green-600 transition flex items-center gap-2">Home</a></li>
                        <li><a href="#" onclick="window.location.href='index.html'" class="hover:text-green-600 transition flex items-center gap-2">Popular Games</a></li>
                        <li><a href="#" onclick="window.location.href='index.html'" class="hover:text-green-600 transition flex items-center gap-2">Top Apps</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-green-50 border border-green-100 p-6 rounded-2xl shadow-sm">
                        ...
                        <p class="text-xs text-gray-500 leading-relaxed">
                            Every file is manually scanned for malware and viruses.
                        </p>
                    </div>
                </div>
            </div>
